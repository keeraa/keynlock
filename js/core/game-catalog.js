...
const GAME_DEFINITIONS={
  ...
  wharf:{title:'Задвижки набережной',description:'Открывай задвижки в скрытом порядке; ошибочный выбор сбрасывает последовательность.',objective:'ОТКРЫТЬ ЗАДВИЖКИ ПО ПОРЯДКУ',kind:'native',lock:{present:true,manualOpen:true},world:{noise:false,guards:false,birds:false}},
