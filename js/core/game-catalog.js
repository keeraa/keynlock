...
const GAME_DEFINITIONS={
  ...
  g1:{title:'Gothic 1',description:'Найди и запомни последовательность поворотов влево и вправо. Повтори её целиком, выбери подходящий натяжитель и открой замок.',kind:'native',lock:{present:true,manualOpen:true,specialTool:true},world:{noise:false,guards:false,birds:false}},
