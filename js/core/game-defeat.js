  class GameDefeat{
    ...
    show(reason='generic',options={}){
      ...
      const message={
        picks:{title:'Отмычки закончились',text:'Вернись в логово и пополни футляр на верстаке. Если нет денег и деталей, разбери старые заготовки бесплатно: их хватит на три отмычки.'},
