...
let plateEls=[], pinTopPlateEls=[];
  ...
  function newLock(notify=true){
    ...
    if(GameCatalog.feature(mode,'lock.requiresPick')&&picks<=0&&!lairOpen){
  ...
  GameActions.registerOpeners({
    ...
    signalbalance:()=>PuzzleModes.call('signalbalance','attemptOpen'),
    workingangle:()=>PuzzleModes.call('workingangle','attemptOpen'),
    turnmemory:()=>PuzzleModes.call('turnmemory','attemptOpen'),
    // Preserve the deferred result: generic call() only reports that a handler ran.
    keyprofile:()=>PuzzleModes.get('keyprofile').attemptOpen(),
    pinflight:()=>PuzzleModes.call('pinflight','attemptOpen'),
    springtumblers:()=>PuzzleModes.call('springtumblers','attemptOpen'),
    silhouettes:()=>PuzzleModes.call('silhouettes','attemptOpen'),
    museum:()=>PuzzleModes.call('museum','attemptOpen'),
    pairednodes:()=>PuzzleModes.call('pairednodes','attemptOpen'),
    pipeline:()=>PuzzleModes.call('pipeline','attemptOpen'),
    wharf:()=>PuzzleModes.call('wharf','attemptOpen'),
    ringsecret:()=>PuzzleModes.call('ringsecret','attemptOpen'),
    cylinderpath:()=>PuzzleModes.call('cylinderpath','attemptOpen'),
    soundlatch:()=>PuzzleModes.call('soundlatch','attemptOpen'),
    torqueangle:()=>PuzzleModes.call('torqueangle','attemptOpen'),
    ringpassage:()=>PuzzleModes.call('ringpassage','attemptOpen'),
    twinbalance:()=>PuzzleModes.call('twinbalance','attemptOpen'),
    timingneedle:()=>PuzzleModes.call('timingneedle','attemptOpen'),
    symbolpins:()=>PuzzleModes.call('symbolpins','attemptOpen')
  });
