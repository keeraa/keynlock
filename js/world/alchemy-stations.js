  ...
  const scenes=[...doc.querySelectorAll('.scene')];
    ...
    const distillation=window.KeynlockAlchemyDistillation.create({
      doc,requestFrame:requestAnimationFrame,shuffle,waveLiquid,setContinuousLiquidReaction,
      setSurface:setDistillSurfaceV83,makeKeyClickable,breakFlask,activeGameName
    });
    const captureDistill=distillation.capture;
    const toggleDistillHeat=distillation.toggleHeat;
