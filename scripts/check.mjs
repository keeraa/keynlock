...
expectedScriptOrder.splice(expectedScriptOrder.indexOf('js/core/init.js'),0,'js/data/campaign.js','js/data/chapter-story.js','js/core/campaign-route.js','js/world/campaign.js','js/world/onboarding.js','js/world/mission-lessons.js','js/world/chapter-story.js');
